      ...
      reader.onload = async (evt) => {
        try {
          ...
          data.forEach(row => {
            ...
            const absent = row["Absent"] !== undefined ? Number(row["Absent"]) : undefined;
            ...
            const allowancesFound = [];
            const deductionsFound = [];
          ...
          if (adjustments.length === 0) {
            toast.error("No valid data found in the spreadsheet.", { id: loadToast });
            return;
          }
