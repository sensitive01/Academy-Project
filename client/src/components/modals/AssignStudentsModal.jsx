...
const AssignStudentsModal = ({ batch, onClose, onAssignSuccess, isTabMode = false }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/50 backdrop-blur-sm flex items-start justify-center p-4 py-10 animate-in fade-in duration-100">
